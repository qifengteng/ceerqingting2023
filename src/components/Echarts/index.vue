...
import { ref, computed, watch, markRaw, onMounted, nextTick, onBeforeUnmount } from "vue";
...
const init = () => {
    ...
    if (!chartInstance.value) {
        chartInstance.value = markRaw(echarts.init(chartRef.value, props.theme, { renderer: props.renderer }));
