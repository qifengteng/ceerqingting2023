<template>
    <el-drawer v-model="drawerVisible" title="布局设置" size="290px">
        ...
        <div class="theme-item">
            ...
            <el-switch v-model="asideInverted" @change="setAsideTheme"></el-switch>
        </div>
        ...
        <div class="theme-item">
            <span>灰色模式</span>
            <el-switch v-model="isGrey" @change="changeGreyOrWeak('grey', !!$event)"></el-switch>
        </div>
        <div class="theme-item">
            <span>色弱模式</span>
            <el-switch v-model="isWeak" @change="changeGreyOrWeak('weak', !!$event)"></el-switch>
        </div>
        ...
        <div class="theme-item">
            <span>面包屑</span>
            <el-switch v-model="breadcrumb"></el-switch>
        </div>
        <div class="theme-item">
            <span>面包屑图标</span>
