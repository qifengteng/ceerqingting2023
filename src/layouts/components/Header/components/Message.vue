                    ...
                    <div class="message-list">
                        <div class="message-item">
                            ...
                            <div class="message-content">
                                <span class="message-title">侧耳倾听 🧡</span>
                                <span class="message-date">2024-1-23 13:37</span>
                            </div>
                        </div>
                        <div class="message-item">
                            <img src="@/assets/images/msg02.png" alt="" class="message-icon" />
                            <div class="message-content">
                                <span class="message-title">你的名字 💙</span>
                        ...
                        <div class="message-item">
                            ...
                            <div class="message-content">
                                <span class="message-title">言叶之庭 💚</span>
                                <span class="message-date">三分钟前</span>
                            </div>
                        </div>
                        <div class="message-item">
                            <img src="@/assets/images/msg04.png" alt="" class="message-icon" />
                            <div class="message-content">
                                <span class="message-title">长安三万里 💜</span>
                        ...
                        <div class="message-item">
                            ...
                            <div class="message-content">
                                <span class="message-title">哈尔的移动城堡 💛</span>
                                <span class="message-date">一个月前</span>
                            </div>
                        </div>
                    </div>
...
.message-list {
    ...
    .message-item {
        ...
        align-items: center;
        padding: 20px 0;
        border-bottom: 1px solid var(--el-border-color-loght);
        &:last-child {
            border: none;
        }
        .message-icon {
